...
//var str = "<img src='"+picArray[i]["filename"]+"'>";
...
newFigure.innerHTML += "<img src='"+picArray[i]["filename"]+"' "+ "alt='"+picArray[i]["title"]+"'>";
newFigCaption.innerHTML += "<figcaption>"+picArray[i]["caption"]+"</figcaption>";
newParagraph.innerHTML += "<p>"+picArray[i]["description"]+"</p>";
//newArticle.innerHTML += "alt='"+picArray[i]["title"]+"' ";
//newArticle.innerHTML += "caption='"+picArray[i]["caption"]+"' "+">";
